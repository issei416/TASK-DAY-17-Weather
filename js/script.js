...
fetchrest().then(res => {
    ...
    res.forEach(country => {
        ...
        weathercard.classList.add("card", "weathercard", "text-center", "col-12", "h-50", "position-absolute", "d-flex", "flex-column", "justify-content-center", "align-items-center");
        ...
        fetchweather().then(res => {
            ...
            weathercardbody.classList.add("p-3", "rounded", "mb-3");
            weathercardbody.style.border = "1px solid"
